...
export function PreprocessingVariancePipeline({ column, recommendedMethod, onApplied }: {
  ...
  return <section role="region" aria-label="Мастер стабилизации дисперсии" className="h-[420px] overflow-y-auto rounded-lg border border-neutral-200 bg-white p-4 feed-scroll">
