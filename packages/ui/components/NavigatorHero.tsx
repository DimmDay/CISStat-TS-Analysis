...
// полигон утоплен на 3 ед. от краёв viewBox: половина обводки (2px,
// non-scaling-stroke) не срезается границами SVG при любом растяжении
// preserveAspectRatio="none". Ширина — clamp(160px,16vw,280px):
// на 1600px видно ~6 стрелок (прежний статичный ряд — 6), на мобильных
// ~2-3. Стрелки стыкуются в цепочку (flex без gap) — как прежний
// бесшовный grid-ряд.

const CHEVRON_ARROW_CLASS =
  "h-11 w-[clamp(160px,16vw,280px)] shrink-0";
...
//
// 14 стрелок на группу — как 14 бейджей главной marquee: гарантирует,
// что группа шире любого распространённого вьюпорта (14 × 280px =
// 3920px ≥ 3840px) — бесшовность стыка при translateX(-50%) не зависит
// от ширины экрана. Flex без gap — стрелки соединяются визуально.
