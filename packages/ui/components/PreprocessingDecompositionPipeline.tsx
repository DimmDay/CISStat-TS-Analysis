...
export function PreprocessingDecompositionPipeline({
  ...
  return <section role="region" aria-label="Мастер декомпозиции ряда" className="h-[468px] overflow-y-auto rounded-lg border border-neutral-200 bg-white p-4 feed-scroll">
