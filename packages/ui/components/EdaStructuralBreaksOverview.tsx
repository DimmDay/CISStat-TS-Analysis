...
export function EdaStructuralBreaksOverview({ profile, loading, error, noDataset, parameters, onParametersChange }: Props) {
  ...
  if (noDataset) return <div role="status" className="flex h-[420px] items-center justify-center rounded-lg bg-neutral-50 px-8 text-center text-sm text-neutral-600">Загрузите датасет, чтобы исследовать структурные сдвиги.</div>;
