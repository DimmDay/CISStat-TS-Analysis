...
function GlobalView({ profile }: { profile: PreprocessingSpectralProfile }) {
  ...
  return <div role="img" aria-label="Глобальные FFT и periodogram спектры" className="grid min-h-0 flex-1 grid-cols-2 grid-rows-1 gap-2 px-2 pt-3"><SpectrumChart data={profile.fft} dataKey="amplitude" label="FFT amplitude" color="#2563eb" /><SpectrumChart data={profile.periodogram} dataKey="power" label="Hann periodogram" color="#7c3aed" /></div>;
}
