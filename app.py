...
from app.preprocessing.transforms import apply_differencing, test_heteroskedasticity, calculate_smoothing_metrics, run_stationarity_tests, calculate_scaling_metrics
        ...
        if st.session_state.col_types.get("num"):
            ...
            if 'Сильная' in props_v12.get('seasonality', '') or 'Умеренная' in props_v12.get('seasonality', ''):
                recommendations.append({
                    ...
                    'Обоснование': 'Модели с сезонной компонентой лучше фиксируют периодичность'
                })
