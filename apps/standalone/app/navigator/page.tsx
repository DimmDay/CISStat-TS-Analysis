...
//
// Футер — последний элемент потока контента; фон — тематический токен
// HomeFooter (светлая #CAD7F7 — тот же, что на главной, «в полном
// соответствии с главной страницей»; DKT-5: тёмная ревизия #171D2C);
// углы rounded-2xl по паттерну фоновой коробки.
