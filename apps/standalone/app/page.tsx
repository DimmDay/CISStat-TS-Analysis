    ...
    <div className="relative isolate -mt-6 pt-6">
      ...
      <div className="relative space-y-12">
        ...
        {/* Task w/n (2026-09-12): футер — последний элемент потока.
            Фон — тематический токен компонента (светлая #CAD7F7, DKT-5:
            тёмная ревизия #171D2C); на других страницах свой цвет
            пропом. Углы rounded-2xl — по паттерну фоновой коробки
            (HomeWavesBackground). Черта между контентом и футером
            убрана (правка 8 в HomeCapabilities). */}
        <HomeFooter />
      </div>
    </div>
  );
